...
function update_table() {
    ...
    cars.forEach(car => {
        ...
        make_cell.onmouseleave = () => {
            make_cell.style.backgroundColor = 'white'
        };
        ...
        model_cell.onmouseleave = () => {
            model_cell.style.backgroundColor = 'white'
        };
        ...
        year_cell.onmouseleave = () => {
            year_cell.style.backgroundColor = 'white'
        };
        ...
        delete_button_cell.innerHTML = '<button class="btn btn-danger" onclick="delete_car(' + car.car_id + ')">Remover</button> <button class="btn btn-primary" onclick="update_car(' + car.car_id + ')">Editar</button>'
    })
